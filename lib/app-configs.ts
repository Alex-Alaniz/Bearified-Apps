...
export const APP_CONFIGS: AppConfig[] = [
  {
    id: "solebrew",
    name: "SoleBrew",
    description: "Premium coffee & streetwear marketplace with blockchain rewards",
    icon: "Coffee",
  ...
  },
  {
    id: "chimpanion",
    name: "Chimpanion",
    description: "AI-powered crypto wallet assistant with natural language control",
    icon: "Bot",
  ...
  },
  {
    id: "golf",
    name: "Golf App",
    description: "Smart golf course management with booking & tournament tools",
    icon: "Globe",
